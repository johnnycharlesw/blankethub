...
import { BlankethubIcon, RightArrowIcon, XIcon } from '@modrinth/assets';
...
<template>
	...
	>
		...
		<div class="flex flex-col gap-2">
			...
			>
			<span class="text-sm font-medium">Create a server with Blankethub in just a few clicks.</span>
		</div>
