...
As part of this campaign, we also added the option to donate part of a Blankethub rewards balance to a variety of charities. This means Blankethub creators can directly use the revenue they earned from ads and [Blankethub+](/plus) to donate to dozens of causes close to their heart. The Trevor Project is one option, alongside other prominent non-profits such as the American Cancer Society, St. Jude's Children's Research Hospital, Doctors Without Borders, and the Southern Poverty Law Center. You can donate your Blankethub balance to these groups and many more by clicking the "Withdraw" button on [your revenue dashboard](/dashboard/revenue).

Blankethub's June 2025 campaign will be kept for posterity at [this link](https://blankethub.localhost/pride).
