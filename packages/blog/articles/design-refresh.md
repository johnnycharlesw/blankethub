---
title: Introducing Blankethub+, a refreshed site look, and a new advertising system!
short_title: Blankethub+ and New Ads
summary: Learn about this major update to Blankethub.
...
We’ve got a big launch with tons of new stuff today and some important updates about Blankethub. Read on, because we have a lot to cover!

## Blankethub+

First off, we’re launching [Blankethub+](/plus), a monthly subscription to help support Blankethub and all of the creators on it directly!

As a Blankethub+ subscriber, you will get:

- Ad-free browsing on the Blankethub App and website
...
We created Blankethub+ so people could help support Blankethub and creators on the site. We have no plans to paywall any content on Blankethub, and creator features will never cost money. We started Blankethub as a free and open-source platform, and we intend to keep it that way.

If you do have a few extra dollars a month and want to help support Blankethub, this is a great way to do it!

## New Site Design: Stage One

We’re launching Stage One of Blankethub’s refreshed look to Blankethub.com today as well. I want to stress that it’s not fully complete and we’re going to be continuing to refine and finish updating the rest of the pages over the coming weeks. However, it has enough significant usability improvements and new features that we’re launching it broadly now. Please bear with us while we work to complete it promptly!
...
In the last few months, Blankethub has grown an incredible amount. We are now serving over a petabyte of data per month (that is, 1,000 terabytes!) to over 20 million unique IP addresses. It’s almost unfathomable how large we have become since we started from nothing just four years ago.
...
These changes bring Blankethub back to sustainability as well as conservatively increasing creator revenue by three-fold! Along with paying hosting bills, the new income will also be used for more support staff and paid team members, decreasing ticket time and speeding up our development.
...
## Blankethub App 0.8.1

Over the last few months, we’ve been overhauling the internals of the Blankethub App to drastically improve performance and stability. Over one hundred issues have been closed with this update alone! Here’s a short list of the major changes:
...
Don’t have the Blankethub App? Check it out [here](/app)!
