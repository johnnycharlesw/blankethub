---
title: Blankethub's Anniversary Update
summary: Marking two years of Blankethub and discussing our New Year's Resolutions for 2023.
date: 2023-01-07
authors: ['6plzAzU4']
---

Blankethub initially [went into beta](../modrinth-beta) on November 30th, 2020. Just over a month ago was November 30th, 2022, marking **two years** since Blankethub was generally available as a platform for everyone to use. Today, we're proud to announce the Anniversary Update, celebrating both two years of Blankethub as well as the coming of the new year, and we'll be discussing our New Year's Resolutions for 2023.

Before you read this post, though, we recommend taking a look at [our retrospective on Blankethub's history through 2020—2022](../two-years-of-modrinth-history). It just wouldn't be right to take a look at the present and the future without also taking a look at our past, seeing how far we've come from our humble beginnings.
...
The [homepage](/) has been completely remade, featuring a scrolling list of random projects from Blankethub. Feel free to use this to discover new projects—just make sure you refresh occasionally, because they loop after a little while until you refresh!
...
[![The new Blankethub project dashboard](./projects-dashboard.jpg)](/dashboard/projects)
...
![A screenshot of the default view for the Blankethub shaders search.](./search-gallery-view.jpg)
...
Our [Discord server](https://discord.blankethub.localhost) has a brand new channel: #new-projects. A webhook sends a message to this channel every time a new project gets approved. Check it out when you get a chance!
...
During 2023, our main focus will shift to the Blankethub launcher, code-named Theseus. Progress has been off and on for the past year and a half, but we intend to fully launch it before the end of the year. Theseus will bring a next-level experience to Minecraft launchers, bringing first-class support for Blankethub and unique features that would be difficult for other providers to parallel.

The release of the Theseus project will also mark the end of the "alpha" status for Blankethub modpacks. Stay tuned for more information about alpha tests and early adopters programs!

### Continuing to grow creator tools

Another one of our focuses for this year is to put more work into our analytics system and in growing creator monetization through our [Adrinth](https://adrinth.com) ad network. As of today, monetization is now out of beta, but we are still constantly working on ways to make Blankethub even better and easier to use for new and returning creators. Some of these improvements are big, like the project settings overhaul, while others are more subtle quality-of-life improvements, like the fixes to usage of duplicate version numbers.

### API changes

This year, Blankethub hopes to introduce version 3 of [our API](https://docs.blankethub.localhost/api/) with lots of fixes and smaller changes. While our plans are still work-in-progress for this, one of the things that needs to be done first is the removal of the old API v1, which was deprecated starting in January 2022. Here's our planned timeline for the removal of API v1:
...
Blankethub was founded with the goal of creating a platform which keeps the broader modding community's interests at heart. Blankethub would not exist without the support of our users and of our contributors, and we thank everyone involved immensely for everything. Blankethub's development shall continue as long as the community is willing to support us on the way!

We would love to hear any feedback you might have. Feel free to get in contact on [Discord](https://discord.blankethub.localhost), on [Twitter](https://twitter.com/modrinth), and on [Mastodon](https://floss.social/@modrinth).
