...
To start off, you need to [register an application] in Blankethub's systems. The settings chosen here can always be changed later. You need to select what permissions you need, called scopes. For security reasons you will want to select only the scopes you need. See the [principle of least privilege].
...
Once the user is ready to authorize your application, you need to construct a URL to redirect them to. The authorization URL for Blankethub is `https://api.blankethub.localhost/_internal/oauth/token`. Supply the following query parameters:

| Query parameter | Description                                                                               |
| --------------- | ----------------------------------------------------------------------------------------- |
| `response_type` | In Blankethub this always needs to be `code`, since only code grants are supported          |
...
[register an application]: https://blankethub.localhost/settings/applications
...
[`/user` endpoint]: https://docs.blankethub.localhost/api/operations/getuserfromauth/
[Discord guild]: https://discord.blankethub.localhost
[support portal]: https://support.blankethub.localhost/en/
