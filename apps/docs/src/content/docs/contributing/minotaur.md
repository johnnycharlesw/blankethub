...
description: Guide for contributing to Blankethub's gradle plugin
---

[Minotaur][minotaur] is the Gradle plugin used to automatically publish artifacts to Blankethub. To run your copy of the plugin in a project, publish it to your local Maven with `./gradlew publishToMavenLocal` and add `mavenLocal()` to your buildscript.
