...
VALUES ({{user_id::ADMIN}},     'Admin',     'admin@blankethub.localhost',     'admin'),
       ({{user_id::MODERATOR}}, 'Moderator', 'moderator@blankethub.localhost', 'moderator'),
       ({{user_id::USER}},      'User',      'user@blankethub.localhost',      'developer'),
       ({{user_id::FRIEND}},    'Friend',    'friend@blankethub.localhost',    'developer'),
       ({{user_id::ENEMY}},     'Enemy',     'enemy@blankethub.localhost',     'developer');
...
VALUES (1, 1, 'https://blankethub.localhost/oauth_callback');
