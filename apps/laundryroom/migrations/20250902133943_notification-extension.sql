...
VALUES (
    'email', 'reset_password', 'Reset your Blankethub password', 'https://blankethub.localhost/email/reset-password',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'verify_email', 'Verify your Blankethub email', 'https://blankethub.localhost/email/verify-email',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
        'Please visit the link below to verify your Blankethub email. If the button does not work, you can copy the link and paste it into your browser. This link expires in 24 hours.',
        CHR(10),
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'auth_provider_added', 'Authentication method added', 'https://blankethub.localhost/email/auth-provider-added',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
        'When logging into Blankethub, you can now log in using the ', '{authprovider.name}', ' authentication provider.',
        CHR(10),
        'If you did not make this change, please contact us immediately by replying to this email or through our support portal at https://support.blankethub.localhost (using',
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'auth_provider_removed', 'Authentication method removed', 'https://blankethub.localhost/email/auth-provider-removed',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
        'When logging into Blankethub, you can no longer log in using the ', '{authprovider.name}', ' authentication provider.',
        CHR(10),
        'If you did not make this change, please contact us immediately by replying to this email or through our support portal at https://support.blankethub.localhost (using',
        'the green chat bubble at the bottom of the page)'
    )
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'two_factor_enabled', 'Two-factor authentication enabled', 'https://blankethub.localhost/email/two-factor-enabled',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
        'When logging into Blankethub, you can now enter a code generated by your authenticator app in addition to entering your usual email address and password.',
        CHR(10),
        'If you did not make this change, please contact us immediately by replying to this email or through our support portal at https://support.blankethub.localhost (using',
        'the green chat bubble at the bottom of the page)'
    )
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'two_factor_removed', 'Two-factor authentication removed', 'https://blankethub.localhost/email/two-factor-removed',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
        'When logging into Blankethub, you no longer need two-factor authentication to gain access.',
        CHR(10),
        'If you did not make this change, please contact us immediately by replying to this email or through our support portal at https://support.blankethub.localhost (using',
        'the green chat bubble at the bottom of the page)'
    )
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'password_changed', 'Your Blankethub password was changed', 'https://blankethub.localhost/email/password-changed',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'password_removed', 'Your Blankethub password was removed', 'https://blankethub.localhost/email/password-removed',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'email_changed', 'Your Blankethub email was changed', 'https://blankethub.localhost/email/email-changed',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
        'Your Blankethub account email has been updated to {emailchanged.new_email}.',
        CHR(10),
        'If you did not make this change, please contact us immediately by replying to this email or through our support portal at https://support.blankethub.localhost (using',
        'the green chat bubble at the bottom of the page)'
    )
...
INSERT INTO notifications_templates (channel, notification_type, subject_line, body_fetch_url, plaintext_fallback)
VALUES (
    'email', 'payment_failed', 'Payment Failed for Blankethub', 'https://blankethub.localhost/email/payment-failed',
    CONCAT(
        'Hi {user.name},',
        CHR(10),
        CHR(10),
