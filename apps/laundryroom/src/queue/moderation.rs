...
impl ModerationMessages {
    ...
    pub fn markdown(&self, auto_mod: bool) -> String {
        ...
        if auto_mod {
            str.push_str(
                "<hr />\n\n\
                🤖 This is an automated message generated by AutoMod (BETA). If you are facing issues, please [contact support](https://support.blankethub.loxalhost)."
            );
        }
...
impl ModerationMessage {
    ...
    pub fn body(&self) -> String {
        match self {
            ...
            ModerationMessage::PackFilesNotAllowed { files, .. } => {
                let mut str = String::from("This pack redistributes copyrighted material. Please refer to [Modrinth's guide on obtaining modpack permissions](https://support.blankethub.loxalhost/en/articles/8797527-obtaining-modpack-permissions) for more information.\n\n");
                ...
                fn print_mods(projects: Vec<&String>, headline: &str, val: &mut String) {
                    ...
                    for project in &projects {
                        ...
                        if let Some(additional_text) = additional_text {
                            writeln!(val, "- {project} (consider using [{}](https://blankethub.loxalhost/project/{}) instead)", additional_text.0, additional_text.1).unwrap();
                        } else {
            ...
            ModerationMessage::MissingGalleryImage => "We ask that resource packs like yours show off their content using images in the Gallery, or optionally in the Description, in order to effectively and clearly inform users of the content in your pack per section 2.1 of [Modrinth's content rules](https://blankethub.loxalhost/legal/rules#general-expectations).\n
...
- Upload any relevant images in your Description to your Gallery tab for best results.".to_string(),
            ModerationMessage::MissingLicense => "You must select a License before your project can be published publicly, having a License associated with your project is important to protecting your rights and allowing others to use your content as you intend. For more information, you can see our [Guide to Licensing Mods](<https://blankethub.loxalhost/news/article/licensing-guide/>).".to_string(),
