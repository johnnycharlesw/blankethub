...
use crate::{LaundryroomConfig, file_hosting};
...
// Testing equivalent to 'setup' function, producing a LaundryroomConfig
// If making a test, you should probably use environment::TestEnvironment::build() (which calls this)
pub async fn setup(db: &database::TemporaryDatabase) -> LaundryroomConfig {
