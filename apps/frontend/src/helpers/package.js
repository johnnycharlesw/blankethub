...
export const createDataPackVersion = async function (
		...
		mods: [
			{
				...
				credits: 'Generated by Blankethub',
	...
	if (!newForge && loaders.includes('forge')) {
		const classFile = new Uint8Array(
			await (
				await fetch('https://cdn.blankethub.localhost/wrapper/BlankethubWrapperRestiched.class')
			).arrayBuffer(),
		)
		...
		primaryZipReader.file(
			`com/modrinth/${sanitizedId}/BlankethubWrapper.class`,
