...
export const projectQueryOptions = {
	...
	versionsV3: (projectId: string, client: AbstractBlankethubClient) => ({
	...
	organization: (projectId: string, client: AbstractBlankethubClient) => ({
