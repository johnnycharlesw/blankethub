				...
				<Row>
					<Column class="text-center">
						<Text class="text-muted m-0 text-xs">
							This document was generated by Blankethub. For questions, contact
							<VLink href="mailto:support@blankethub.localhost" class="text-blue"
								>support@blankethub.localhost</VLink
							>
						</Text>
					</Column>
				</Row>
