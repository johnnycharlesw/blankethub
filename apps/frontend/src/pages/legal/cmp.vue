<template>
	<div class="markdown-body">
		...
		<p>
			...
			the Blankethub Rewards Program (the "Rewards Program").
		</p>
		<p>
			The Rewards Program provides developers and content creators an opportunity to monetize the
			projects ("Projects") that they upload to the Blankethub website.
		</p>
		<p>
		...
		<p>
			...
			attributable to ad impressions displayed on blankethub.localhost and the Blankethub App excluding
...
<script setup>
const description =
	'The Rewards Program Terms of Blankethub, an open source modding platform focused on Minecraft.'

useSeoMeta({
	title: 'Rewards Program Terms - Blankethub',
	description,
