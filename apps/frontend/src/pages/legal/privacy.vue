<template>
	<div class="markdown-body">
		...
		<h2>Introduction</h2>
		<p>
			<a href="https://blankethub.localhost">Blankethub</a> is part of Rinth, Inc. ("Company", "us", "we",
		...
		<p>
			...
			when you use www.blankethub.localhost, api.blankethub.localhost, or the Blankethub App ("Service" or "Website"),
		...
		<p>Rinth, Inc. is the data controller for data collected through Blankethub.</p>
		...
		<p>When you view a project page or download a file from Blankethub, we collect:</p>
		<ul>
		...
		<h3>Playtime data</h3>
		<p>When you use the Blankethub App to play Blankethub projects, we collect:</p>
		<ul>
			<li>Your IP address</li>
			<li>Your user ID</li>
		...
		<h3>Usage data</h3>
		<p>When you interact with the Blankethub App or the Website, we collect through PostHog:</p>
		<ul>
			<li>Your IP address</li>
		...
		<p>
			We use some third-party services to make Blankethub run. Please refer to each of their privacy
		...
		<p>
			...
			<a href="mailto:gdpr@blankethub.localhost">gdpr@blankethub.localhost</a>. We may ask you to verify your
		...
		<p>
			Blankethub does not knowingly collect any Personal Identifiable Information from children under
		...
		<p>
			...
			website with regards to the information that they shared and/or collect in Blankethub. This
		...
		<p>
			...
			<a href="mailto:gdpr@blankethub.localhost">gdpr@blankethub.localhost</a> or write us at:
		</p>
		<p>
			Rinth, Inc.<br />
...
<script setup>
const description =
	'The Privacy Policy of Blankethub, an open source modding platform focused on Minecraft.'

useSeoMeta({
	title: 'Privacy Policy - Blankethub',
	description,
