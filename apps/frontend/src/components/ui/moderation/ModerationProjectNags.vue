...
const messages = defineMessages({
	...
	resubmitForReviewDesc: {
		...
		defaultMessage:
			"Your project has been {status, select, rejected {rejected} withheld {withheld} other {{status}}} by Blankethub's staff. In most cases, you can resubmit for review after addressing the staff's message.",
	},
	visitModerationPage: {
